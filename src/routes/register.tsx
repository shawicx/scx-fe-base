...
import { registerFormSchema, sendVerificationCodeSchema } from '@/lib/schemas';
...
export default function Register(): React.ReactElement {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toaster.create({ title: '注册成功', type: 'success' });
      navigate('/');
    } catch (error) {
      toaster.create({
        title: '注册失败',
    ...
    <Flex minH="100vh" align="center" justify="center" bg="blue.50" px={4}>
      <Box w="full" maxW="md" bg="white" rounded="2xl" shadow="2xl" p={10}>
        ...
        <Box mt={8} pt={6} borderTop="1px" borderColor="gray.200" textAlign="center">
          已有账号？
          <RouterLink to="/login" className="text-blue-600 font-bold hover:underline ml-1">
            立即登录
          </RouterLink>
        </Box>
      </Box>
